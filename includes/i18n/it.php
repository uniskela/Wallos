...
$i18n = [
    ...
    "edit_widgets_hint" => "Trascina per riordinare. Usa l’occhio per mostrare o nascondere. L’ingranaggio configura i budget per metodo di pagamento; + ne aggiunge un altro.",
    "reorder_widget" => "Drag to reorder",
    "show_widget" => "Show widget",
    "hide_widget" => "Hide widget",
    "configure_payment_method_budget" => "Configura metodi di pagamento",
    "remove_payment_method_budget" => "Rimuovi questo widget",
    "add_payment_method_budget" => "Aggiungi budget per metodo di pagamento",
    "widget_title" => "Titolo del widget",
    "select_payment_methods" => "Metodi di pagamento",
    "payment_method_budget_select_info" => "Lascia tutto deselezionato per includere tutti i metodi con budget. Oppure scegli metodi specifici per questo widget.",
    "payment_method_budget_display_mode" => "Visualizzazione",
    "payment_method_budget_display_per_method" => "Ogni metodo di pagamento sulla propria riga",
    "payment_method_budget_display_combined" => "Combina i metodi selezionati in un totale",
    "payment_method_budget_display_info" => "Combinato somma budget e importo necessario dei metodi selezionati in un'unica riga.",
    "confirm_remove_payment_method_budget" => "Rimuovere questo widget di budget per metodo di pagamento?",
    "cannot_remove_last_payment_method_budget" => "Mantieni almeno un widget di budget per metodo di pagamento, oppure nascondilo con l’occhio.",
    ...
    "cost_vs_monthly_budget" => "Costo vs Budget Mensile",
    "cost_vs_period_budget" => "Costo vs Budget del Periodo",
    "send_period_summary_at_period_start" => "Invia un riepilogo all'inizio di ogni periodo di pagamento",
    "amount_for_pay_period" => "Importo per il Periodo di Pagamento",
    "remaining" => "Rimanente",
    "amount_needed_this_period" => "Importo necessario in questo periodo",
    ...
    "ai_provider_error" => "Errore del provider IA",
    "ai_invalid_response" => "Il provider IA ha restituito una risposta non valida.",
    "ai_invalid_json_response" => "La risposta dell'IA non conteneva raccomandazioni valide.",
    ...
    "ssrf_allowlist_env_managed" => "Gestito dalla variabile d'ambiente SSRF_ALLOWLIST.",
