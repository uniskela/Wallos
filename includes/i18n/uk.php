...
$i18n = [
    ...
    "cost_vs_monthly_budget" => "Вартість vs Місячний бюджет",
    "cost_vs_period_budget" => "Вартість vs Бюджет періоду",
    "send_period_summary_at_period_start" => "Надсилати підсумок на початку кожного платіжного періоду",
    "amount_for_pay_period" => "Сума за платіжний період",
    "remaining" => "Залишок",
    "amount_needed_this_period" => "Необхідна сума у цьому періоді",
    ...
    "push_notifications_info" => "Отримуйте сповіщення в браузері або на екрані блокування телефону без окремого облікового запису чи додатка. Працює в настільних Chrome, Firefox та Edge, на Android, а на iOS - з головного екрана після встановлення Wallos як застосунку.",
    "no_devices_registered" => "Поки що немає зареєстрованих пристроїв.",
    "unknown_device" => "Невідомий пристрій",
    "enable_on_this_device" => "Увімкнути на цьому пристрої",
    ...
    "no_api_key_provider" => "Або виберіть провайдера, якому не потрібен ні акаунт, ні API-ключ, і залиште поле ключа порожнім:",
    "ai_model" => "AI Модель",
    ...
    "ai_provider_error" => "Помилка постачальника AI",
    "ai_invalid_response" => "Постачальник AI повернув недійсну відповідь.",
    "ai_invalid_json_response" => "Відповідь AI не містила дійсних рекомендацій.",
    ...
    "currency_provider_saved" => "Провайдера валюти успішно збережено",
    ...
    "ssrf_allowlist_env_managed" => "Керується змінною середовища SSRF_ALLOWLIST.",
