...
$i18n = [
    ...
    "monthly_budget_info" => "Месечни буџет се упоређује са укупним месечним трошком ваших претплата.",
    "period_budget" => "Буџет периода",
    "period_budget_info" => "Буџет периода прати колико треба да платите у изабраном периоду буџета.",
    ...
    "edit_widgets_hint" => "Drag to reorder. Use the eye to show or hide. Gear configures payment method budget widgets; + adds another.",
    "reorder_widget" => "Drag to reorder",
    "show_widget" => "Show widget",
    "hide_widget" => "Hide widget",
    "configure_payment_method_budget" => "Configure payment methods",
    "remove_payment_method_budget" => "Remove this widget",
    "add_payment_method_budget" => "Add payment method budget",
    "widget_title" => "Widget title",
    "select_payment_methods" => "Payment methods",
    "payment_method_budget_select_info" => "Leave all unchecked to include every payment method that has a budget. Or pick specific methods for this widget.",
    "payment_method_budget_display_mode" => "Display",
    "payment_method_budget_display_per_method" => "Each payment method on its own row",
    "payment_method_budget_display_combined" => "Combine selected methods into one total",
    "payment_method_budget_display_info" => "Combined sums budgets and amount needed for the selected methods into a single row.",
    "confirm_remove_payment_method_budget" => "Remove this payment method budget widget?",
    "cannot_remove_last_payment_method_budget" => "Keep at least one payment method budget widget, or hide it with the eye icon.",
    "widget_no_data" => "Nothing to show yet",

    "budget_period" => "Период буџета",
    "budget_anchor_date" => "Референтни датум",
    "fortnightly" => "Двонедељно",
    "cost_vs_monthly_budget" => "Трошак vs Месечни буџет",
    "cost_vs_period_budget" => "Трошак vs Буџет периода",
    "send_period_summary_at_period_start" => "Пошаљи сажетак на почетку сваког периода плаћања",
    "amount_for_pay_period" => "Износ за период плаћања",
    "remaining" => "Преостало",
    "amount_needed_this_period" => "Потребан износ у овом периоду",
    ...
    "push_notifications" => "Push обавештења",
    "push_notifications_info" => "Примајте обавештење у прегледачу или на закључаном екрану телефона, без сопственог налога или апликације. Ради у Chrome, Firefox и Edge на рачунару, на Android-у, и на iOS-у са почетног екрана након инсталирања Wallos-а као апликације.",
    "no_devices_registered" => "Још увек нема регистрованих уређаја.",
    "unknown_device" => "Непознат уређај",
    "enable_on_this_device" => "Омогући на овом уређају",
    ...
    "no_api_key_provider" => "Или изаберите добављача коме није потребан налог ни API кључ, и оставите поље кључа празно:",
    "ai_model" => "AI Модел",
    ...
    "ai_provider_error" => "Грешка AI провајдера",
    "ai_invalid_response" => "AI провајдер је вратио неважећи одговор.",
    "ai_invalid_json_response" => "AI одговор није садржао важеће препоруке.",
    ...
    "currency_provider_saved" => "Добављач валуте је успешно сачуван",
    ...
    "ssrf_allowlist_env_managed" => "Управља се преко променљиве окружења SSRF_ALLOWLIST.",
