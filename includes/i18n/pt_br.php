...
$i18n = [
    ...
    "monthly_budget_info" => "O orçamento mensal é comparado com o custo total mensal das suas assinaturas.",
    "period_budget" => "Orçamento do Período",
    "period_budget_info" => "O orçamento do período acompanha o que você precisa pagar dentro do período de orçamento escolhido.",
    "payment_method_budget" => "Orçamento por método de pagamento",
    "payment_method_budget_info" => "Defina um orçamento por método de pagamento. O painel compara com o valor necessário no período orçamentário atual (mesma janela do orçamento por período).",
    ...
    "edit_widgets_hint" => "Arraste para reordenar. Use o olho para mostrar ou ocultar. A engrenagem configura orçamentos por método de pagamento; + adiciona outro.",
    "reorder_widget" => "Drag to reorder",
    "show_widget" => "Show widget",
    "hide_widget" => "Hide widget",
    "configure_payment_method_budget" => "Configurar métodos de pagamento",
    "remove_payment_method_budget" => "Remover este widget",
    "add_payment_method_budget" => "Adicionar orçamento por método de pagamento",
    "widget_title" => "Título do widget",
    "select_payment_methods" => "Métodos de pagamento",
    "payment_method_budget_select_info" => "Deixe tudo desmarcado para incluir todos os métodos com orçamento. Ou escolha métodos específicos para este widget.",
    "payment_method_budget_display_mode" => "Exibição",
    "payment_method_budget_display_per_method" => "Cada método de pagamento em sua própria linha",
    "payment_method_budget_display_combined" => "Combinar os métodos selecionados em um total",
    "payment_method_budget_display_info" => "Combinado soma orçamentos e valor necessário dos métodos selecionados em uma única linha.",
    "confirm_remove_payment_method_budget" => "Remover este widget de orçamento por método de pagamento?",
    "cannot_remove_last_payment_method_budget" => "Mantenha pelo menos um widget de orçamento por método de pagamento, ou oculte-o com o olho.",
    "widget_no_data" => "Nothing to show yet",

    "budget_period" => "Período de orçamento",
    "budget_anchor_date" => "Data de referência",
    "fortnightly" => "Quinzenal",
    "cost_vs_monthly_budget" => "Custo vs Orçamento Mensal",
    "cost_vs_period_budget" => "Custo vs Orçamento do Período",
    "send_period_summary_at_period_start" => "Enviar resumo no início de cada período de pagamento",
    "amount_for_pay_period" => "Valor para o Período de Pagamento",
    "remaining" => "Restante",
    "amount_needed_this_period" => "Valor necessário neste período",
    ...
    "push_notifications_info" => "Receba uma notificação no seu navegador ou na tela de bloqueio do celular, sem precisar de conta ou aplicativo próprio. Funciona no Chrome, Firefox e Edge no computador, no Android, e no iOS a partir da tela inicial depois de instalar o Wallos como aplicativo.",
    "no_devices_registered" => "Nenhum dispositivo registrado ainda.",
    "unknown_device" => "Dispositivo desconhecido",
    "enable_on_this_device" => "Ativar neste dispositivo",
    ...
    "no_api_key_provider" => "Ou selecione um provedor que não precisa de conta nem de chave de API, e deixe a chave vazia:",
    ...
    "ai_provider_error" => "Erro do provedor de IA",
    "ai_invalid_response" => "O provedor de IA retornou uma resposta inválida.",
    "ai_invalid_json_response" => "A resposta da IA não continha recomendações válidas.",
    ...
    "currency_provider_saved" => "Provedor de moeda salvo com sucesso",
    ...
    "ssrf_allowlist_env_managed" => "Gerenciado pela variável de ambiente SSRF_ALLOWLIST.",
