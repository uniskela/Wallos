...
$i18n = [
    ...
    "monthly_budget_info" => "Det månedlige budget sammenlignes med dine samlede månedlige abonnementsudgifter.",
    "period_budget" => "Periodebudget",
    "period_budget_info" => "Periodebudgettet holder styr på, hvad du skal betale i den valgte budgetperiode.",
    ...
    "budget_anchor_date" => "Startdato",
    "fortnightly" => "Fjorten dage",
    "cost_vs_monthly_budget" => "Udgift vs. månedligt budget",
    "cost_vs_period_budget" => "Udgift vs. periodebudget",
    "send_period_summary_at_period_start" => "Send opsummering ved starten af hver betalingsperiode",
    "amount_for_pay_period" => "Beløb for betalingsperiode",
    "remaining" => "Resterende",
    "amount_needed_this_period" => "Nødvendigt beløb i denne periode",
    ...
    "push_notifications_info" => "Få en notifikation i din browser eller på din telefons låseskærm uden behov for egen konto eller app. Virker i desktop Chrome, Firefox og Edge, på Android, og på iOS fra hjemmeskærmen efter installation af Wallos som app.",
    "no_devices_registered" => "Ingen enheder registreret endnu.",
    "unknown_device" => "Ukendt enhed",
    "enable_on_this_device" => "Aktivér på denne enhed",
