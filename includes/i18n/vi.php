...
$i18n = [
    ...
    "cost_vs_monthly_budget" => "Chi phí so với Ngân sách hàng tháng",
    "cost_vs_period_budget" => "Chi phí so với Ngân sách theo kỳ",
    "send_period_summary_at_period_start" => "Gửi tóm tắt vào đầu mỗi kỳ thanh toán",
    "amount_for_pay_period" => "Số tiền cho Kỳ thanh toán",
    "remaining" => "Còn lại",
    "amount_needed_this_period" => "Số tiền cần trong kỳ này",
    ...
    "push_notifications_info" => "Nhận thông báo trên trình duyệt hoặc trên màn hình khóa điện thoại, không cần tài khoản hay ứng dụng riêng. Hoạt động trên Chrome, Firefox và Edge trên máy tính, trên Android, và trên iOS từ màn hình chính sau khi cài đặt Wallos như một ứng dụng.",
    "no_devices_registered" => "Chưa có thiết bị nào được đăng ký.",
    "unknown_device" => "Thiết bị không xác định",
    "enable_on_this_device" => "Bật trên thiết bị này",
    "categories" => "Danh mục",
    ...
    "ai_provider_error" => "Lỗi nhà cung cấp AI",
    "ai_invalid_response" => "Nhà cung cấp AI đã trả về phản hồi không hợp lệ.",
    "ai_invalid_json_response" => "Phản hồi AI không chứa đề xuất hợp lệ.",
    ...
    "ssrf_allowlist_env_managed" => "Được quản lý bởi biến môi trường SSRF_ALLOWLIST.",
