...
$i18n = [
    ...
    "edit_widgets_hint" => "Sleep om te herordenen. Gebruik het oog om te tonen of te verbergen. Tandwiel configureert betaalmethode-budgetten; + voegt er een toe.",
    "reorder_widget" => "Drag to reorder",
    "show_widget" => "Show widget",
    "hide_widget" => "Hide widget",
    "configure_payment_method_budget" => "Betaalmethoden configureren",
    "remove_payment_method_budget" => "Deze widget verwijderen",
    "add_payment_method_budget" => "Betaalmethode-budget toevoegen",
    "widget_title" => "Widgettitel",
    "select_payment_methods" => "Betaalmethoden",
    "payment_method_budget_select_info" => "Laat alles uit om alle methoden met budget op te nemen. Of kies specifieke methoden voor deze widget.",
    "payment_method_budget_display_mode" => "Weergave",
    "payment_method_budget_display_per_method" => "Elke betaalmethode op een eigen rij",
    "payment_method_budget_display_combined" => "Geselecteerde methoden combineren tot één totaal",
    "payment_method_budget_display_info" => "Gecombineerd telt budgetten en benodigd bedrag van de geselecteerde methoden op tot één rij.",
    "confirm_remove_payment_method_budget" => "Deze betaalmethode-budgetwidget verwijderen?",
    "cannot_remove_last_payment_method_budget" => "Houd minstens één betaalmethode-budgetwidget, of verberg hem met het oog.",
    "widget_no_data" => "Nothing to show yet",

    "budget_period" => "Budgetperiode",
    "budget_anchor_date" => "Startdatum",
    "fortnightly" => "Tweewekelijks",
    "cost_vs_monthly_budget" => "Kosten vs Maandbudget",
    "cost_vs_period_budget" => "Kosten vs Periodebudget",
    "send_period_summary_at_period_start" => "Verzend samenvatting bij start van elke betaalperiode",
    "amount_for_pay_period" => "Bedrag voor Betaalperiode",
    "remaining" => "Resterend",
    "amount_needed_this_period" => "Benodigd bedrag deze periode",
    ...
    "push_notifications_info" => "Ontvang een melding in je browser of op het vergrendelscherm van je telefoon, zonder eigen account of app. Werkt in desktop Chrome, Firefox en Edge, op Android, en op iOS vanaf het beginscherm nadat Wallos als app is geïnstalleerd.",
    "no_devices_registered" => "Nog geen apparaten geregistreerd.",
    "unknown_device" => "Onbekend apparaat",
    "enable_on_this_device" => "Inschakelen op dit apparaat",
    ...
    "ai_provider_error" => "AI-providerfout",
    "ai_invalid_response" => "De AI-provider heeft een ongeldig antwoord geretourneerd.",
    "ai_invalid_json_response" => "Het AI-antwoord bevatte geen geldige aanbevelingen.",
    ...
    "ssrf_allowlist_env_managed" => "Wordt beheerd door de omgevingsvariabele SSRF_ALLOWLIST.",
