...
$i18n = [
    ...
    "cost_vs_monthly_budget" => "Cost vs Pressupost Mensual",
    "cost_vs_period_budget" => "Cost vs Pressupost del Període",
    "send_period_summary_at_period_start" => "Envia un resum a l'inici de cada període de pagament",
    "amount_for_pay_period" => "Import per al Període de Pagament",
    "remaining" => "Restant",
    "amount_needed_this_period" => "Import necessari aquest període",
    ...
    "push_notifications_info" => "Rebeu una notificació al navegador o a la pantalla de bloqueig del telèfon, sense necessitat de compte ni aplicació pròpia. Funciona a Chrome, Firefox i Edge d'escriptori, a Android, i a iOS des de la pantalla d'inici després d'instal·lar Wallos com a aplicació.",
    "no_devices_registered" => "Encara no hi ha dispositius registrats.",
    "unknown_device" => "Dispositiu desconegut",
    "enable_on_this_device" => "Activa en aquest dispositiu",
    ...
    "ai_provider_error" => "Error del proveïdor d'IA",
    "ai_invalid_response" => "El proveïdor d'IA ha retornat una resposta no vàlida.",
    "ai_invalid_json_response" => "La resposta de la IA no contenia recomanacions vàlides.",
    ...
    "ssrf_allowlist_env_managed" => "Gestionat per la variable d'entorn SSRF_ALLOWLIST.",
