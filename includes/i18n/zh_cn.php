...
$i18n = [
    ...
    "edit_widgets_hint" => "拖动可排序。用眼睛图标显示或隐藏。齿轮配置付款方式预算；+ 再添加一个。",
    "reorder_widget" => "Drag to reorder",
    "show_widget" => "Show widget",
    "hide_widget" => "Hide widget",
    "configure_payment_method_budget" => "配置付款方式",
    "remove_payment_method_budget" => "移除此小组件",
    "add_payment_method_budget" => "添加付款方式预算",
    "widget_title" => "小组件标题",
    "select_payment_methods" => "付款方式",
    "payment_method_budget_select_info" => "全部不勾选表示包含所有已设置预算的付款方式。也可为此小组件选择特定方式。",
    "payment_method_budget_display_mode" => "显示方式",
    "payment_method_budget_display_per_method" => "每种付款方式单独一行",
    "payment_method_budget_display_combined" => "将所选方式合并为一个总计",
    "payment_method_budget_display_info" => "合并会将所选付款方式的预算与所需金额加总到一行。",
    "confirm_remove_payment_method_budget" => "移除此付款方式预算小组件？",
    "cannot_remove_last_payment_method_budget" => "请至少保留一个付款方式预算小组件，或用眼睛图标隐藏。",
