...
$i18n = [
    ...
    "cost_vs_monthly_budget" => "Trošak vs Mesečni budžet",
    "cost_vs_period_budget" => "Trošak vs Budžet perioda",
    "send_period_summary_at_period_start" => "Pošalji sažetak na početku svakog perioda plaćanja",
    "amount_for_pay_period" => "Iznos za period plaćanja",
    "remaining" => "Preostalo",
    "amount_needed_this_period" => "Potreban iznos u ovom periodu",
    ...
    "push_notifications_info" => "Primajte obaveštenje u pregledaču ili na zaključanom ekranu telefona, bez sopstvenog naloga ili aplikacije. Radi u Chrome, Firefox i Edge na računaru, na Android-u, i na iOS-u sa početnog ekrana nakon instaliranja Wallos-a kao aplikacije.",
    "no_devices_registered" => "Još uvek nema registrovanih uređaja.",
    "unknown_device" => "Nepoznat uređaj",
    "enable_on_this_device" => "Omogući na ovom uređaju",
    ...
    "no_api_key_provider" => "Ili izaberite dobavljača kome nije potreban nalog ni API ključ, i ostavite polje ključa prazno:",
    "ai_model" => "AI Model",
    ...
    "ai_provider_error" => "Greška AI provajdera",
    "ai_invalid_response" => "AI provajder je vratio nevažeći odgovor.",
    "ai_invalid_json_response" => "AI odgovor nije sadržao važeće preporuke.",
    ...
    "currency_provider_saved" => "Dobavljač valute je uspešno sačuvan",
    ...
    "ssrf_allowlist_env_managed" => "Upravlja se preko promenljive okruženja SSRF_ALLOWLIST.",
