...
$i18n = [
    ...
    "edit_widgets_hint" => "Arrastra para reordenar. Usa el ojo para mostrar u ocultar. El engranaje configura presupuestos por método de pago; + añade otro.",
    "reorder_widget" => "Arrastrar para reordenar",
    "show_widget" => "Mostrar widget",
    "hide_widget" => "Ocultar widget",
    "configure_payment_method_budget" => "Configurar métodos de pago",
    "remove_payment_method_budget" => "Quitar este widget",
    "add_payment_method_budget" => "Añadir presupuesto por método de pago",
    "widget_title" => "Título del widget",
    "select_payment_methods" => "Métodos de pago",
    "payment_method_budget_select_info" => "Deja todo sin marcar para incluir todos los métodos con presupuesto. O elige métodos concretos para este widget.",
    "payment_method_budget_display_mode" => "Visualización",
    "payment_method_budget_display_per_method" => "Cada método de pago en su propia fila",
    "payment_method_budget_display_combined" => "Combinar los métodos seleccionados en un total",
    "payment_method_budget_display_info" => "Combinado suma presupuestos e importe necesario de los métodos seleccionados en una sola fila.",
    "confirm_remove_payment_method_budget" => "¿Quitar este widget de presupuesto por método de pago?",
    "cannot_remove_last_payment_method_budget" => "Mantén al menos un widget de presupuesto por método de pago, o ocúltalo con el ojo.",
    "widget_no_data" => "Aún no hay nada que mostrar",

    "budget_period" => "Periodo de presupuesto",
    "budget_anchor_date" => "Fecha de referencia",
    "fortnightly" => "Quincena(s)",
    "cost_vs_monthly_budget" => "Costo vs Presupuesto Mensual",
    "cost_vs_period_budget" => "Costo vs Presupuesto del Periodo",
    "send_period_summary_at_period_start" => "Enviar resumen al inicio de cada periodo de pago",
    "amount_for_pay_period" => "Monto para el Periodo de Pago",
    "remaining" => "Restante",
    "amount_needed_this_period" => "Monto necesario este periodo",
    ...
    "push_notifications_info" => "Recibe una notificación en tu navegador o en la pantalla de bloqueo de tu teléfono, sin necesidad de cuenta ni aplicación propia. Funciona en Chrome, Firefox y Edge de escritorio, en Android, y en iOS desde la pantalla de inicio tras instalar Wallos como aplicación.",
    "no_devices_registered" => "Aún no hay dispositivos registrados.",
    "unknown_device" => "Dispositivo desconocido",
    "enable_on_this_device" => "Activar en este dispositivo",
    ...
    "no_api_key_provider" => "O selecciona un proveedor que no necesite cuenta ni clave de API, y deja la clave vacía:",
    ...
    "ai_invalid_response" => "El proveedor de IA devolvió una respuesta no válida.",
    "ai_invalid_json_response" => "La respuesta de la IA no contenía recomendaciones válidas.",
    ...
    "currency_provider_saved" => "Proveedor de divisas guardado correctamente",
    ...
    "ssrf_allowlist_env_managed" => "Gestionado por la variable de entorno SSRF_ALLOWLIST.",
