...
$i18n = [
    ...
    "edit_widgets_hint" => "Przeciągnij, aby zmienić kolejność. Oko pokazuje lub ukrywa. Koło zębate konfiguruje budżety metod płatności; + dodaje kolejny.",
    "reorder_widget" => "Drag to reorder",
    "show_widget" => "Show widget",
    "hide_widget" => "Hide widget",
    "configure_payment_method_budget" => "Konfiguruj metody płatności",
    "remove_payment_method_budget" => "Usuń ten widget",
    "add_payment_method_budget" => "Dodaj budżet metody płatności",
    "widget_title" => "Tytuł widgetu",
    "select_payment_methods" => "Metody płatności",
    "payment_method_budget_select_info" => "Pozostaw wszystko odznaczone, aby uwzględnić wszystkie metody z budżetem. Albo wybierz konkretne metody dla tego widgetu.",
    "payment_method_budget_display_mode" => "Wyświetlanie",
    "payment_method_budget_display_per_method" => "Każda metoda płatności w osobnym wierszu",
    "payment_method_budget_display_combined" => "Połącz wybrane metody w jedną sumę",
    "payment_method_budget_display_info" => "Połączone sumuje budżety i potrzebną kwotę wybranych metod w jednym wierszu.",
    "confirm_remove_payment_method_budget" => "Usunąć ten widget budżetu metody płatności?",
    "cannot_remove_last_payment_method_budget" => "Zachowaj co najmniej jeden widget budżetu metody płatności albo ukryj go ikoną oka.",
    ...
    "cost_vs_monthly_budget" => "Koszt vs Budżet Miesięczny",
    "cost_vs_period_budget" => "Koszt vs Budżet Okresu",
    "send_period_summary_at_period_start" => "Wysyłaj podsumowanie na początku każdego okresu płatności",
    "amount_for_pay_period" => "Kwota za okres płatności",
    "remaining" => "Pozostało",
    "amount_needed_this_period" => "Kwota potrzebna w tym okresie",
    "current_period" => "Aktualny okres",
    ...
    "push_notifications_info" => "Otrzymuj powiadomienia w przeglądarce lub na ekranie blokady telefonu, bez własnego konta czy aplikacji. Działa w Chrome, Firefox i Edge na komputerze, na Androidzie oraz na iOS z ekranu głównego po zainstalowaniu Wallos jako aplikacji.",
    "no_devices_registered" => "Nie zarejestrowano jeszcze żadnych urządzeń.",
    "unknown_device" => "Nieznane urządzenie",
    "enable_on_this_device" => "Włącz na tym urządzeniu",
    ...
    "no_api_key_provider" => "Lub wybierz dostawcę, który nie wymaga konta ani klucza API, i pozostaw klucz pusty:",
    "ai_model" => "Model AI",
    ...
    "ai_provider_error" => "Błąd dostawcy AI",
    "ai_invalid_response" => "Dostawca AI zwrócił nieprawidłową odpowiedź.",
    "ai_invalid_json_response" => "Odpowiedź AI nie zawierała prawidłowych rekomendacji.",
    ...
    "currency_provider_saved" => "Dostawca waluty został zapisany",
    ...
    "ssrf_allowlist_env_managed" => "Zarządzane przez zmienną środowiskową SSRF_ALLOWLIST.",
