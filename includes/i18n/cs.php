...
$i18n = [
    ...
    "cost_vs_monthly_budget" => "Náklady vs měsíční rozpočet",
    "cost_vs_period_budget" => "Náklady vs rozpočet na období",
    "send_period_summary_at_period_start" => "Odeslat souhrn na začátku každého platebního období",
    "amount_for_pay_period" => "Částka za platební období",
    "remaining" => "Zbývá",
    "amount_needed_this_period" => "Potřebná částka v tomto období",
    ...
    "push_notifications_info" => "Dostávejte oznámení v prohlížeči nebo na uzamykací obrazovce telefonu bez nutnosti vlastního účtu nebo aplikace. Funguje v desktopových prohlížečích Chrome, Firefox a Edge, na Androidu a na iOS z plochy po instalaci Wallos jako aplikace.",
    "no_devices_registered" => "Zatím nejsou registrována žádná zařízení.",
    "unknown_device" => "Neznámé zařízení",
    "enable_on_this_device" => "Povolit na tomto zařízení",
    ...
    "ai_provider_error" => "Chyba poskytovatele AI",
    "ai_invalid_response" => "Poskytovatel AI vrátil neplatnou odpověď.",
    "ai_invalid_json_response" => "Odpověď AI neobsahovala platná doporučení.",
    ...
    "ssrf_allowlist_env_managed" => "Řízeno proměnnou prostředí SSRF_ALLOWLIST.",
