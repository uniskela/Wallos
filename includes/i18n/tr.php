...
$i18n = [
    ...
    "cost_vs_monthly_budget" => "Maliyet vs Aylık Bütçe",
    "cost_vs_period_budget" => "Maliyet vs Dönem Bütçesi",
    "send_period_summary_at_period_start" => "Her ödeme döneminin başında özet gönder",
    "amount_for_pay_period" => "Ödeme Dönemi Tutarı",
    "remaining" => "Kalan",
    "amount_needed_this_period" => "Bu dönemde gereken tutar",
    ...
    "push_notifications_info" => "Kendi hesabı veya uygulaması olmadan tarayıcınızda veya telefonunuzun kilit ekranında bildirim alın. Masaüstü Chrome, Firefox ve Edge'de, Android'de ve Wallos'u uygulama olarak yükledikten sonra iOS'ta ana ekrandan çalışır.",
    "no_devices_registered" => "Henüz kayıtlı cihaz yok.",
    "unknown_device" => "Bilinmeyen cihaz",
    "enable_on_this_device" => "Bu cihazda etkinleştir",
    ...
    "ai_provider_error" => "AI sağlayıcı hatası",
    "ai_invalid_response" => "AI sağlayıcısı geçersiz bir yanıt döndürdü.",
    "ai_invalid_json_response" => "AI yanıtı geçerli öneriler içermiyordu.",
    ...
    "ssrf_allowlist_env_managed" => "SSRF_ALLOWLIST ortam değişkeni tarafından yönetilir.",
