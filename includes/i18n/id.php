...
$i18n = [
    ...
    "cost_vs_monthly_budget" => "Biaya vs Anggaran Bulanan",
    "cost_vs_period_budget" => "Biaya vs Anggaran Periode",
    "send_period_summary_at_period_start" => "Kirim ringkasan di awal setiap periode pembayaran",
    "amount_for_pay_period" => "Jumlah untuk Periode Pembayaran",
    "remaining" => "Sisa",
    "amount_needed_this_period" => "Jumlah yang dibutuhkan periode ini",
    ...
    "push_notifications_info" => "Dapatkan notifikasi di browser Anda atau di layar kunci ponsel Anda, tanpa perlu akun atau aplikasi tersendiri. Berfungsi di Chrome, Firefox, dan Edge desktop, di Android, dan di iOS dari layar utama setelah menginstal Wallos sebagai aplikasi.",
    "no_devices_registered" => "Belum ada perangkat yang terdaftar.",
    "unknown_device" => "Perangkat tidak dikenal",
    "enable_on_this_device" => "Aktifkan di perangkat ini",
    "categories" => "Kategori",
    ...
    "ai_provider_error" => "Kesalahan penyedia AI",
    "ai_invalid_response" => "Penyedia AI mengembalikan respons yang tidak valid.",
    "ai_invalid_json_response" => "Respons AI tidak berisi rekomendasi yang valid.",
    ...
    "ssrf_allowlist_env_managed" => "Dikelola oleh variabel lingkungan SSRF_ALLOWLIST.",
