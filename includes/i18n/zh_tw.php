...
$i18n = [
    ...
    "edit_widgets_hint" => "拖曳可排序。用眼睛圖示顯示或隱藏。齒輪設定付款方式預算；+ 再新增一個。",
    "reorder_widget" => "Drag to reorder",
    "show_widget" => "Show widget",
    "hide_widget" => "Hide widget",
    "configure_payment_method_budget" => "設定付款方式",
    "remove_payment_method_budget" => "移除此小工具",
    "add_payment_method_budget" => "新增付款方式預算",
    "widget_title" => "小工具標題",
    "select_payment_methods" => "付款方式",
    "payment_method_budget_select_info" => "全部不勾選表示包含所有已設定預算的付款方式。也可為此小工具選擇特定方式。",
    "payment_method_budget_display_mode" => "顯示方式",
    "payment_method_budget_display_per_method" => "每種付款方式單獨一行",
    "payment_method_budget_display_combined" => "將所選方式合併為一個總計",
    "payment_method_budget_display_info" => "合併會將所選付款方式的預算與所需金額加總到一行。",
    "confirm_remove_payment_method_budget" => "移除此付款方式預算小工具？",
    "cannot_remove_last_payment_method_budget" => "請至少保留一個付款方式預算小工具，或用眼睛圖示隱藏。",
    ...
    "cost_vs_period_budget" => "費用與週期預算對比",
    "send_period_summary_at_period_start" => "在每個付款週期開始時傳送摘要",
    ...
    "push_notifications_info" => "不需要另外的帳戶或應用程式，即可在瀏覽器或手機鎖定畫面收到通知。適用於桌面版 Chrome、Firefox 和 Edge，以及 Android；在 iOS 上，將 Wallos 安裝為應用程式後可從主畫面使用。",
    "no_devices_registered" => "尚未註冊任何裝置。",
    "unknown_device" => "未知裝置",
    "enable_on_this_device" => "在此裝置上啟用",
    "categories" => "分類",
    "save_category" => "儲存分類",
