...
$i18n = [
    ...
    "monthly_budget_info" => "Bugetul lunar este comparat cu costul total lunar al abonamentelor tale.",
    "period_budget" => "Bugetul perioadei",
    "period_budget_info" => "Bugetul perioadei urmărește ce trebuie să plătești în perioada de buget aleasă.",
    ...
    "budget_period" => "Perioadă de buget",
    "budget_anchor_date" => "Data de referință",
    "fortnightly" => "Bisăptămânal",
    "cost_vs_monthly_budget" => "Cost vs Buget Lunar",
    "cost_vs_period_budget" => "Cost vs Bugetul Perioadei",
    "send_period_summary_at_period_start" => "Trimite un rezumat la începutul fiecărei perioade de plată",
    "amount_for_pay_period" => "Suma pentru Perioada de Plată",
    "remaining" => "Rămas",
    "amount_needed_this_period" => "Suma necesară în această perioadă",
    ...
    "push_notifications_info" => "Primește o notificare în browser sau pe ecranul de blocare al telefonului, fără a fi nevoie de cont sau aplicație proprie. Funcționează în Chrome, Firefox și Edge pe desktop, pe Android, și pe iOS de pe ecranul principal după instalarea Wallos ca aplicație.",
    "no_devices_registered" => "Niciun dispozitiv înregistrat încă.",
    "unknown_device" => "Dispozitiv necunoscut",
    "enable_on_this_device" => "Activează pe acest dispozitiv",
    ...
    "ai_provider_error" => "Eroare furnizor AI",
    "ai_invalid_response" => "Furnizorul AI a returnat un răspuns nevalid.",
    "ai_invalid_json_response" => "Răspunsul AI nu a conținut recomandări valide.",
    ...
    "ssrf_allowlist_env_managed" => "Gestionat de variabila de mediu SSRF_ALLOWLIST.",
