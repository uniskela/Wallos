...
$i18n = [
    ...
    "edit_widgets_hint" => "Glissez pour réordonner. Utilisez l’œil pour afficher ou masquer. L’engrenage configure les budgets par moyen de paiement ; + en ajoute un autre.",
    "reorder_widget" => "Glisser pour réordonner",
    "show_widget" => "Afficher le widget",
    "hide_widget" => "Masquer le widget",
    "configure_payment_method_budget" => "Configurer les moyens de paiement",
    "remove_payment_method_budget" => "Supprimer ce widget",
    "add_payment_method_budget" => "Ajouter un budget par moyen de paiement",
    "widget_title" => "Titre du widget",
    "select_payment_methods" => "Moyens de paiement",
    "payment_method_budget_select_info" => "Laissez tout décoché pour inclure tous les moyens avec un budget. Ou choisissez des moyens précis pour ce widget.",
    "payment_method_budget_display_mode" => "Affichage",
    "payment_method_budget_display_per_method" => "Chaque moyen de paiement sur sa propre ligne",
    "payment_method_budget_display_combined" => "Combiner les moyens sélectionnés en un total",
    "payment_method_budget_display_info" => "Combiné additionne les budgets et le montant nécessaire des moyens sélectionnés sur une seule ligne.",
    "confirm_remove_payment_method_budget" => "Supprimer ce widget de budget par moyen de paiement ?",
    "cannot_remove_last_payment_method_budget" => "Conservez au moins un widget de budget par moyen de paiement, ou masquez-le avec l’œil.",
    ...
    "cost_vs_monthly_budget" => "Coût vs Budget Mensuel",
    "cost_vs_period_budget" => "Coût vs Budget de la Période",
    "send_period_summary_at_period_start" => "Envoyer un résumé au début de chaque période de paiement",
    "amount_for_pay_period" => "Montant pour la Période de Paiement",
    "remaining" => "Restant",
    "amount_needed_this_period" => "Montant nécessaire pour cette période",
    ...
    "push_notifications_info" => "Recevez une notification dans votre navigateur ou sur l'écran de verrouillage de votre téléphone, sans compte ni application propre à configurer. Fonctionne sur Chrome, Firefox et Edge de bureau, sur Android, et sur iOS depuis l'écran d'accueil après avoir installé Wallos comme application.",
    "no_devices_registered" => "Aucun appareil enregistré pour le moment.",
    "unknown_device" => "Appareil inconnu",
    "enable_on_this_device" => "Activer sur cet appareil",
    ...
    "ai_provider_error" => "Erreur du fournisseur d'IA",
    "ai_invalid_response" => "Le fournisseur d'IA a renvoyé une réponse invalide.",
    "ai_invalid_json_response" => "La réponse de l'IA ne contenait pas de recommandations valides.",
    ...
    "ssrf_allowlist_env_managed" => "Géré par la variable d'environnement SSRF_ALLOWLIST.",
