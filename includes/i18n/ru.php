...
$i18n = [
    ...
    "monthly_budget_info" => "Месячный бюджет сравнивается с общей ежемесячной стоимостью ваших подписок.",
    "period_budget" => "Бюджет периода",
    "period_budget_info" => "Бюджет периода отслеживает, сколько нужно заплатить в выбранном бюджетном периоде.",
    ...
    "edit_widgets_hint" => "Перетащите для порядка. Глаз показывает или скрывает. Шестерёнка настраивает бюджеты способов оплаты; + добавляет ещё один.",
    "reorder_widget" => "Drag to reorder",
    "show_widget" => "Show widget",
    "hide_widget" => "Hide widget",
    "configure_payment_method_budget" => "Настроить способы оплаты",
    "remove_payment_method_budget" => "Удалить этот виджет",
    "add_payment_method_budget" => "Добавить бюджет способа оплаты",
    "widget_title" => "Заголовок виджета",
    "select_payment_methods" => "Способы оплаты",
    "payment_method_budget_select_info" => "Оставьте всё снятым, чтобы включить все способы с бюджетом. Или выберите конкретные способы для этого виджета.",
    "payment_method_budget_display_mode" => "Отображение",
    "payment_method_budget_display_per_method" => "Каждый способ оплаты отдельной строкой",
    "payment_method_budget_display_combined" => "Объединить выбранные способы в одну сумму",
    "payment_method_budget_display_info" => "Объединённый режим суммирует бюджеты и нужную сумму выбранных способов в одну строку.",
    "confirm_remove_payment_method_budget" => "Удалить этот виджет бюджета способа оплаты?",
    "cannot_remove_last_payment_method_budget" => "Оставьте хотя бы один виджет бюджета способа оплаты или скрывайте его значком глаза.",
    ...
    "cost_vs_monthly_budget" => "Стоимость vs Месячный бюджет",
    "cost_vs_period_budget" => "Стоимость vs Бюджет периода",
    "send_period_summary_at_period_start" => "Отправлять сводку в начале каждого платёжного периода",
    "amount_for_pay_period" => "Сумма за платёжный период",
    "remaining" => "Осталось",
    "amount_needed_this_period" => "Необходимая сумма в этом периоде",
    ...
    "push_notifications_info" => "Получайте уведомления в браузере или на экране блокировки телефона без отдельной учётной записи или приложения. Работает в настольных Chrome, Firefox и Edge, на Android, а на iOS - с главного экрана после установки Wallos как приложения.",
    "no_devices_registered" => "Пока нет зарегистрированных устройств.",
    "unknown_device" => "Неизвестное устройство",
    "enable_on_this_device" => "Включить на этом устройстве",
    ...
    "ai_provider_error" => "Ошибка провайдера ИИ",
    "ai_invalid_response" => "Провайдер ИИ вернул недействительный ответ.",
    "ai_invalid_json_response" => "Ответ ИИ не содержал допустимых рекомендаций.",
    ...
    "ssrf_allowlist_env_managed" => "Управляется переменной окружения SSRF_ALLOWLIST.",
