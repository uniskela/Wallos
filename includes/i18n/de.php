...
$i18n = [
    ...
    "edit_widgets_hint" => "Zum Neuordnen ziehen. Mit dem Augen-Symbol ein- oder ausblenden. Zahnrad konfiguriert Zahlungsmethoden-Budgets; + fügt ein weiteres hinzu.",
    "reorder_widget" => "Ziehen zum Neuordnen",
    "show_widget" => "Widget anzeigen",
    "hide_widget" => "Widget ausblenden",
    "configure_payment_method_budget" => "Zahlungsmethoden konfigurieren",
    "remove_payment_method_budget" => "Dieses Widget entfernen",
    "add_payment_method_budget" => "Zahlungsmethoden-Budget hinzufügen",
    "widget_title" => "Widget-Titel",
    "select_payment_methods" => "Zahlungsmethoden",
    "payment_method_budget_select_info" => "Nichts auswählen, um alle Zahlungsmethoden mit Budget einzuschließen. Oder bestimmte Methoden für dieses Widget wählen.",
    "payment_method_budget_display_mode" => "Anzeige",
    "payment_method_budget_display_per_method" => "Jede Zahlungsmethode in eigener Zeile",
    "payment_method_budget_display_combined" => "Ausgewählte Methoden zu einer Summe kombinieren",
    "payment_method_budget_display_info" => "Kombiniert summiert Budgets und benötigten Betrag der ausgewählten Methoden in einer Zeile.",
    "confirm_remove_payment_method_budget" => "Dieses Zahlungsmethoden-Budget-Widget entfernen?",
    "cannot_remove_last_payment_method_budget" => "Behalte mindestens ein Zahlungsmethoden-Budget-Widget, oder blende es mit dem Augen-Symbol aus.",
