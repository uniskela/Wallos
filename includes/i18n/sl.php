...
$i18n = [
    ...
    "monthly_budget_info" => "Mesečni proračun se primerja s skupnimi mesečnimi stroški vaših naročnin.",
    "period_budget" => "Proračun obdobja",
    "period_budget_info" => "Proračun obdobja sledi, koliko morate plačati v izbranem proračunskem obdobju.",
    ...
    "budget_period" => "Proračunsko obdobje",
    "budget_anchor_date" => "Izhodiščni datum",
    "fortnightly" => "Vsaka dva tedna",
    "cost_vs_monthly_budget" => "Stroški vs Mesečni proračun",
    "cost_vs_period_budget" => "Stroški vs Proračun obdobja",
    "send_period_summary_at_period_start" => "Pošlji povzetek na začetku vsakega plačilnega obdobja",
    "amount_for_pay_period" => "Znesek za plačilno obdobje",
    "remaining" => "Preostalo",
    "amount_needed_this_period" => "Potreben znesek v tem obdobju",
    ...
    "push_notifications_info" => "Prejemajte obvestilo v brskalniku ali na zaklenjenem zaslonu telefona, brez lastnega računa ali aplikacije. Deluje v namiznih brskalnikih Chrome, Firefox in Edge, na Androidu ter na iOS z domačega zaslona po namestitvi Wallos kot aplikacije.",
    "no_devices_registered" => "Še ni registriranih naprav.",
    "unknown_device" => "Neznana naprava",
    "enable_on_this_device" => "Omogoči na tej napravi",
    ...
    "ai_provider_error" => "Napaka ponudnika AI",
    "ai_invalid_response" => "Ponudnik AI je vrnil neveljaven odgovor.",
    "ai_invalid_json_response" => "Odgovor AI ni vseboval veljavnih priporočil.",
    ...
    "ssrf_allowlist_env_managed" => "Upravljano s spremenljivko okolja SSRF_ALLOWLIST.",
