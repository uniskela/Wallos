...
$i18n = [
    ...
    "payment_method_budget_display_mode" => "Apresentação",
    "payment_method_budget_display_per_method" => "Cada método de pagamento na sua própria linha",
    "payment_method_budget_display_combined" => "Combinar os métodos selecionados num total",
    "payment_method_budget_display_info" => "Combinado soma orçamentos e valor necessário dos métodos selecionados numa única linha.",
    ...
    "amount_for_pay_period" => "Montante para o Período de Pagamento",
    "remaining" => "Restante",
    "amount_needed_this_period" => "Montante necessário neste período",
    ...
    "push_notifications_info" => "Receba uma notificação no seu navegador ou no ecrã de bloqueio do telemóvel, sem necessidade de conta ou aplicação própria. Funciona no Chrome, Firefox e Edge no computador, no Android, e no iOS a partir do ecrã principal depois de instalar o Wallos como aplicação.",
    ...
    "no_api_key_provider" => "Ou selecione um fornecedor que não precisa de conta nem de chave API, e deixe a chave vazia:",
    ...
    "ai_provider_error" => "Erro do fornecedor de IA",
    "ai_invalid_response" => "O fornecedor de IA devolveu uma resposta inválida.",
    ...
    "currency_provider_saved" => "Fornecedor de moeda guardado com sucesso",
    ...
    "ssrf_allowlist_env_managed" => "Gerido pela variável de ambiente SSRF_ALLOWLIST.",
